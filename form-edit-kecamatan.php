...
$sql= "SELECT * FROM kecamatan WHERE
...
<form method= "post" action= "proses-edit-kecamatan.php?id_kecamatan=<?=$id_kecamatan?>">
<table width= "600" border= "0">

<tr>
<td><h5>Nama Kecamatan </h5></td> 
<td width= "435"><input type= "text"
name= "nama_kecamatan" size= "30"
value= "<?php echo
...
<tr>
<td><h5>Jumlah Desa/Kelurahan </h5></td>
<td>
<input type="text"
name="jumlah_desa"
size= "30"
value= "<?php echo
$kabupaten['jumlah_desa'];?>"/>
</td>
</tr>

<td>
                                            <h5>Kabupaten </h5>
                                    <td> <select name="id_kabupaten">
           <?php
            include "config.php";
