...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          ...
          <br><br><br><h2>Form Input Desa/Kelurahan</h2><br>
                            <form method="POST" action="proses-pendaftaran-desa.php">
                                <table width="100%" border="0">
                                    <tr>
                                        <td width="180">
                                            <h5>Nama Desa/Kelurahan </h5>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="jumlah_penduduk" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5>Kecamatan </h5>
  ...
  ?>
                                    ...
                                    <tr>
                                        <td><input type="hidden" name="id_desa" value="0" />
                                        </td>
