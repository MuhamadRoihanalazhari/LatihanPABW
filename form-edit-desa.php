...
<h2>Form Update Desa/Kelurahan</h2>
<form method= "post" action= "proses-edit-desa.php?id_kecamatan=<?=$id_desa?>">
<table width= "600" border= "0">

<tr>
<td><h5>Nama Desa </h5></td> 
<td width= "433"><input type= "text"
name= "nama_desa" size= "30"
value= "<?php echo
$kabupaten['nama_desa'];?>"/>
...
<tr>
<td><h5>Jumlah Penduduk </h5></td>
<td>
<input type="text"
name="jumlah_penduduk"
size= "30"
value= "<?php echo
$kabupaten['jumlah_penduduk'];?>"/>
</td>
</tr>
...
<td>
           ...
           <?php
            ...
            if (isset($_GET['desa'])) {
                ...
                if ($kabupaten==$kabupaten['id_kecamatan'])
                {
                    $ket="selected";
                }
            }
            ?>
            <option <?php echo $ket; ?> value="<?php echo $kabupaten['id_kecamatan'];?>"><?php echo $kabupaten['nama_kecamatan'];?></option>
            <?php
	}
  ?>
        </select></td>
