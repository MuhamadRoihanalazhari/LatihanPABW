...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          ...
          <br><br><br><h2> kecamatan yang sudah terdaftar</h2>
                            <nav>
                                <br><a class="btn_2" href="form-input-kecamatan.php">[+] Tambah Baru</a>
                            </nav>
        ...
        $sql = "SELECT * FROM kecamatan, kabupaten WHERE kecamatan.id_kabupaten =
 kabupaten.id_kabupaten ";;
        ...
        while($kabupaten = mysqli_fetch_array($query)){
            ...
            echo "<td>".$kabupaten['id_kecamatan']."</td>";
            echo "<td>".$kabupaten['nama_kecamatan']."</td>";
            echo "<td>".$kabupaten['jumlah_desa']."</td>";
            echo "<td>".$kabupaten['nama_kabupaten']."</td>";
            echo "<td>".$kabupaten['ibukota_kabupaten']."</td>";
            
            echo "<td>";
            echo "<a href='form-edit-kecamatan.php?id_kecamatan=".$kabupaten['id_kecamatan']."'title='Edit'><img src='iedit.png' width='20' height='20' </a>";
            echo "<a href='hapus-kecamatan.php?id_kecamatan=".$kabupaten['id_kecamatan']."'onclick=\"return confirm('Apakah anda yakin menghapus data ?')\"title='Hapus'><img src='ihapus.png' width='20' height='20'  </a>";
