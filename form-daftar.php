    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          ...
          <h2>Form Input Kabupaten</h2><br>
                            <form method="POST" action="proses_pendaftaran.php">
                                <table width="100%" border="0">
                                    <tr>
                                        <td width="150">
                                            <h5>Nama Kabupaten </h5>
                                        </td>
                                        <td><input type="text" name="nama_kabupaten" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5>Ibukota Kabupaten </h5>
                                        </td>
                                        <td><input type="text" name="ibukota_kabupaten" size="30" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5>Luas Wilayah </h5>
                                        </td>
                                        <td><input type="text" name="luas_wilayah" size="5" /></td>
                                    </tr>
                                    <tr>
                                        <td><input type="hidden" name="id_kabupaten" value="0" />
                                        </td>
